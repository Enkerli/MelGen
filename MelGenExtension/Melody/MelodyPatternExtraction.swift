...
extension MelodyPatterns {
    ...
    static func extract(from notes: [SequencedNote],
    ...
    static func degree(of pitch: Int,
                       at beat: Double,
    ...
    static func describe(_ notes: [PatternNote], bars: Int) -> String {
...
struct PatternFitReport: Sendable, Hashable {
    ...
    var onAvoidNotes: Int
    /// Whether the pattern tiles the progression evenly, or gets cut off.
    var tilesEvenly: Bool

    var isClean: Bool { placed == requested && offScale == 0 && onAvoidNotes == 0 && tilesEvenly }
...
extension MelodyPatterns {
    ...
    static func fitReport(for pattern: MelodyPattern,

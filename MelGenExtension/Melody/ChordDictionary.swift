...
struct ChordQuality: Hashable, Sendable {
...
enum ChordDictionary {

    static func quality(forKey key: String) -> ChordQuality? {
        keyIndex[key]
    }
    ...
    static func quality(forSuffix suffix: String) -> ChordQuality? {
    ...
    static func displaySuffix(forKey key: String) -> String {
